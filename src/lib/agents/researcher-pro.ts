/**
 * Pro Researcher Agent - Gathers evidence supporting YES outcome
 */
...
const SYSTEM_PROMPT = `You are a research analyst gathering evidence that SUPPORTS a positive outcome.

Your task:
1. Search for credible evidence supporting the YES outcome
...
export async function runProResearcherAgent(
...
Extract ${Math.min(MAX_EVIDENCE_PER_SIDE, 3)} pieces of evidence that SUPPORT the positive outcome.`
